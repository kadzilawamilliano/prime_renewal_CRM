...
st.subheader(
    ":material/dashboard: Management Dashboard"
)
# =====================================
# LOAD ALL CALL RECORDS
# =====================================

dashboard_history = pd.read_sql_query(
...
portfolio_premium = df["Premium"].fillna(0).sum()

retained_premium = history.loc[
    history["renewed"] == "Yes",
    "premium"
].fillna(0).sum()
